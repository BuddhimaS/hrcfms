...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center">
            ...
            <!-- Form Section -->
            <div class="col-md-10">
                <form action="{{ route('pickcab.store_pickcab') }}" method="POST">
                    @csrf
                            ...
                            <div id="roomSlider" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{ url('public/img/car.jpg') }}" class="img-fluid rounded" alt="Swedish Massages">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ url('public/img/meal1.jpg') }}" class="img-fluid rounded" alt="Deluxe Room 2">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7">
                            <div class="form-container">
                                ...
                                <div class="row mt-4 text-center">
                                    ...
                                    <div class="col-md-4">
                                        <button type="button" class="btn btn-warning w-100 service-btn">Cab Service</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button type="button" class="btn btn-light w-100 service-btn" onclick="window.location.href='{{ route('guest.pickspa') }}'">Spa Service</button>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 d-inline-flex align-items-center">
                                    <label class="form-label" style="margin-right: 20px;">Pickup Time</label>
                                    <select class="form-select mt-2" name="pickup_time" required>
                                ...
                                <!-- Vehicle Type -->
                                <div class="mb-3 d-inline-flex align-items-center">
                                    <label class="form-label" style="margin-right: 20px;">Vehicle Type</label>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <button type="submit" class="btn btn-secondary action-btn">Add Cab</button>
