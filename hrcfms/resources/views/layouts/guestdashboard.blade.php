...
<head>
  ...
  <link rel="stylesheet" href="{{url('public/dashboard/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{url('public/dashboard/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{url('public/dashboard/plugins/jqvmap/jqvmap.min.css')}}">
  <!-- Theme style -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{url('public/dashboard/plugins/daterangepicker/daterangepicker.css')}}">
  <!-- summernote -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src={{url('public/img/sitaralogo1.jpg')}} alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src={{url('public/img/user.png')}} class="img-circle elevation-2" alt="User Image" width="20" height="10">
        </div>
        <div class="info">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{route('guest.roomreservation')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Room Reservation</p>
                    </a>
                </li>  
                <li class="nav-item">
                    <a href="{{route('guest.meal')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Meal Reservations</p>
                    </a>
                </li> 
                <li class="nav-item">
                    <a href="{{route('guest.spa')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Spa Reservations</p>
                    </a>
                </li>        
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{route('guest.review')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Add Review</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('guest.complaint')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Add Complain</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('guest.feedback')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Submit Feedback</p>
                    </a>
                </li>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{url('public/dashboard/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
...
<!-- JQVMap -->
<script src="{{url('public/dashboard/plugins/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{url('public/dashboard/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<!-- jQuery Knob Chart -->
...
<script src="{{url('public/dashboard/dist/js/pages/dashboard.js')}}"></script>
</body>
